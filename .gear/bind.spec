...
# filetrigger: restart named if its plugins were installed/upgraded as well
# named itself
...
%changelog
* Thu Oct 14 2021 Stanislav Levin <slev@altlinux.org> 9.16.21-alt1
- 9.11.32 -> 9.16.21.
