/* $Header: /proj/cvs/isc/bind8/contrib/dns_signer/parse/bind_support.h,v 1.1 1999/01/05 03:02:29 vixie Exp $ */
#ifndef __bind_support_h__
#define __bind_support_h__

#include <sys/types.h>

/*	These are generally useful additions to BIND library routines. */

/*	wire_to_ascii_name

	Improves on ns_name_ntop by appending a dot to the name it returns. 
*/
...
/*	print_response
	...
	Calls the resolver library routine to pretty print the response.
*/
...
/*	dns_lookup
	...
	Does a somewhat raw query/response of a DNS nameserver.
*/
